 ...
 */
public class MarkerActivity extends Activity implements OnClickListener, AMap.OnMapClickListener {
	...
	public void onMapClick(LatLng latLng) {
        ...
        Log.d("map","点击了地图上的位置"+"latitude=="+latitude+"longtitude==="+longtitude);
